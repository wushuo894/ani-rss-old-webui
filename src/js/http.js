 ...
 * @returns {Promise<unknown>}
 */
export let getWebUIUpdate = () => api.post('api/webui/getUpdate')

/**
 * 更新已安装 WebUI
 * @returns {Promise<unknown>}
 */
export let updateWebUI = () => api.post('api/webui/update')

/**
 * 删除已安装 WebUI，恢复内置界面
 * @returns {Promise<unknown>}
 */
export let deleteWebUI = () => api.post('api/webui/delete')
